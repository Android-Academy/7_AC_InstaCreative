...
public class RegisterActivity extends AppCompatActivity {
    ...
    private static final String LOG_TAG = "RegisterLog";
    ...
    private void registerUser(String txtUsername, String txtName, String txtEmail, String txtPassword) {
        ...
        mAuth.createUserWithEmailAndPassword(txtEmail, txtPassword).addOnSuccessListener(new OnSuccessListener<AuthResult>() {
            ...
            public void onSuccess(AuthResult authResult) {
                ...
                Log.d(LOG_TAG, "registerUser success");
                ...
                mRootRef.child("Users").child(mAuth.getCurrentUser().getUid()).setValue(userObject).addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
